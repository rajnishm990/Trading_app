...
def transform_alpha_vantage_data(timestamp_str, result):
...
class AlphaVantageAPIClient:
    ...
    def get_api_key(self):
        return self.api_key or ALPHA_API_KEY
    ...
    def get_stock_data(self):
        ...
        for timestamp_str in results.keys():
            dataset.append(
                transform_alpha_vantage_data(timestamp_str, results.get(timestamp_str))
            )
        return dataset
